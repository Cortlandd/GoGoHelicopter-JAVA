...
import com.game.gogohelicopter.android.TweenAccessors.Value;
import com.game.gogohelicopter.android.TweenAccessors.ValueAccessor;
import com.game.gogohelicopter.android.gghhelpers.AssetLoader;
import com.game.gogohelicopter.android.gghhelpers.InputHandler;
import com.game.gogohelicopter.android.objects.Grass;
import com.game.gogohelicopter.android.objects.Helicopter;
import com.game.gogohelicopter.android.objects.Pipe;
import com.game.gogohelicopter.android.objects.ScrollHandler;
import com.game.gogohelicopter.android.ui.SimpleButton;
...
public class GameRenderer {
    ...
    private void drawHelicopterCentered(float runTime) {
        batcher.draw((TextureRegion) helicopterAnimation.getKeyFrame(runTime), 59, helicopter.getY() - 15,
    ...
    private void drawHelicopter(float runTime) {
        ...
        if (helicopter.shouldntFlap()) {
            ...
            batcher.draw((TextureRegion) helicopterAnimation.getKeyFrame(runTime), helicopter.getX(),
